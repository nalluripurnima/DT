...
public class CategoryController 
{
	...
	public ModelAndView addCategory( @ModelAttribute("eshop") Category c,BindingResult result) 
	{
	...
	public ModelAndView storeCategory(HttpServletRequest request, @ModelAttribute("eshop") Category c, BindingResult result)
	{
	...
	public ModelAndView updateCategory(HttpServletRequest request, @ModelAttribute("eshop") Category c, BindingResult result) 
	{
		System.out.println("Store Category");
		c.setCid(tcid);
		iCategoryService.updateCategory(c);
		return new ModelAndView("addcategory", "command", new Category()).addObject("addcategory", iCategoryService.viewAllCategory()).addObject("stat", "update Product");
	}
